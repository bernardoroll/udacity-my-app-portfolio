...
public interface DashboardPresenter extends CommonPresenter {
    ...
    String getMakeYourAppMaterialString();
    String getGoUbiquitousString();
    String getCapstoneString();

    String getPopularMoviesLaunchAppString();
    String getStockHawkLaunchAppString();
    String getBuildItBiggerLaunchAppString();
